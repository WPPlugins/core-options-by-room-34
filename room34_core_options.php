...
class Room34CoreOptions {
	...
	var $options = array(
		...
		'admin_font' => array(
			...
			'group' => 'Admin Interface',
			'action' => 'admin_head',
			'title' => 'Customize WordPress Admin Font',
			'description' => null,
			'type' => 'select',
			'options' => array(
				null => '[default]',
		...
		'content_refinements' => array(
			...
			'options' => array(
				...
				'Enable SVG uploads' =>				"add_filter('upload_mimes', function(\$mimes) {
		...
		'custom_css' => array(
			...
			'action' => 'wp_head',
			'title' => 'Custom CSS',
			'description' => 'Add custom CSS to your pages to override elements of your theme without creating a child theme.',
			'type' => 'textarea',
		),
